...
## Notes and requirements
 ...
 - Due to size constraints for this demo, Metricbeat for perfomance monitoring and Filebeat are available as roles, but have not been added. This can be changed in your site.yml file by adding the roles.
...
[site.yml]: https://github.com/maggiejg/ansible-playbook-elk.git
